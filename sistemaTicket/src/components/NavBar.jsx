...
const NavBar = () => {
  return (
    <header className="flex place-content-between items-center  bg-gray-300 p-4">
        
      <div>
        <h1 className="w-35 h-38 font-bold">Configuración para tickets</h1>
      </div>
      ...
      <ul className='hidden sm:flex text-[18px] sm:w-[438px] sm:place-content-around sm:text-[16px] sm:items-center'>
        ...
        <li><a href="#">Registro de Errores</a></li>
